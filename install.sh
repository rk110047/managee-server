...
sudo apt-get -y install postgresql postgresql-contrib postgresql-server-dev-all libpq-dev
...
sudo apt-get update
sudo apt-get -y install python3-pip python3.8 apache2 libapache2-mod-wsgi-py3
