...
OTP for your change password request is [OTP].
...
class Emailer(object):
    ...
    def send_forgot_password_email(self, receiver_email, otp):
        msg = forgot_pass_message.replace('[FROM]', self.sender).replace('[TO]', receiver_email).replace('[OTP]', otp)
        self.send_email(receiver_email, msg)
